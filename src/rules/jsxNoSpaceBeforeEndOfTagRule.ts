...
export class Rule extends Lint.Rules.AbstractRule {
    ...
    public static metadata: Lint.IRuleMetadata = {
        ruleName: "jsx-no-space-before-end-of-tag",
        description: "Checks that JSX elements do not have a space before the '>' part.",
        options: null,
        optionsDescription: "",
        optionExamples: ["true"],
        type: "style",
    ...
    public static FAILURE_STRING = "JSX elements must not have a space before the '>' part";
